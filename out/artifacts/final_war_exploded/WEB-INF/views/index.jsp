          ...
          %>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                    <a href="#"><%out.print(i.getName());%></a>
                  </h4>
                  <h5>$ <%out.print(i.getPrice());%></h5>
                  <p class="card-text">Universal product code is <%out.print(i.getUpc());%>. <%out.print(i.getAmounts());%> left in stock</p>
                </div>
                ...
                <div class="card-footer">
                  ...
                  <form action="/buy" method="post">
                    <input type="number" name="number" required max="<%=i.getAmounts()%>" style="width: 50px;border-radius: 8px;margin-left:30px;margin-right: 50px">
                    <input type="number" name="id" hidden value="<%=i.getId()%>">
